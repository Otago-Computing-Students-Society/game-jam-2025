...
function detectOSColorTheme() {
    chosenThemeIsDark ? document.documentElement.setAttribute("data-theme", "dark") : chosenThemeIsLight ? document.documentElement.setAttribute("data-theme", "light") : window.matchMedia("(prefers-color-scheme: dark)").matches ? document.documentElement.setAttribute("data-theme", "dark") : document.documentElement.setAttribute("data-theme", "light")
}
function switchTheme() {
    chosenThemeIsDark ? localStorage.setItem("theme", "light") : chosenThemeIsLight ? localStorage.setItem("theme", "dark") : document.documentElement.getAttribute("data-theme") == "dark" ? localStorage.setItem("theme", "light") : localStorage.setItem("theme", "dark"),
    detectOSColorTheme(),
    window.location.reload()
}
themeToggle ? (themeToggle.addEventListener("click", switchTheme, !1),
...
detectOSColorTheme()) : localStorage.removeItem("theme");
...
const language = document.getElementsByTagName("html")[0].lang
  , logo = document.querySelector(".logo__pathname");
logo && (window.onload = () => {
    let e = window.location.pathname.substring(1);
    e = e.replace(language + "/", ""),
    logo.textContent += e.substring(0, e.indexOf("/"))
}
);
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}
  , Prism = function(e) {
    var s, r, o = /\blang(?:uage)?-([\w-]+)\b/i, l = 0, t = {
        ...
        languages: {
            extend: function(e, n) {
                var o, s = t.util.clone(t.languages[e]);
                for (o in n)
                    s[o] = n[o];
                return s
            },
            insertBefore: function(e, n, s, o) {
                var a, c, l, r = (o = o || t.languages)[e], i = {};
                for (a in r)
            ...
            DFS: function e(n, s, o, i) {
                ...
                for (r in n)
                    if (n.hasOwnProperty(r)) {
                        s.call(n, r, n[r], o || r);
                        var r, c, a = n[r], l = t.util.type(a);
                        "Object" !== l || i[c(a)] ? "Array" !== l || i[c(a)] || (i[c(a)] = !0,
                        e(a, s, r, i)) : (i[c(a)] = !0,
                        e(a, s, null, i))
                    }
            }
        ...
        highlightElement: function(n, s, i) {
            var a, r, d, c = t.util.getLanguage(n), u = t.languages[c];
            n.className = n.className.replace(o, "").replace(/\s+/g, " ") + " language-" + c,
            r = n.parentElement,
            r && "pre" === r.nodeName.toLowerCase() && (r.className = r.className.replace(o, "").replace(/\s+/g, " ") + " language-" + c),
            a = {
                element: n,
                language: c,
                grammar: u,
            ...
            if (t.hooks.run("before-sanity-check", a),
            !a.code)
                return t.hooks.run("complete", a),
                void (i && i.call(a.element));
            t.hooks.run("before-highlight", a),
            a.grammar ? s && e.Worker ? (d = new Worker(t.filename),
            ...
            d.postMessage(JSON.stringify({
                ...
                code: a.code,
                immediateClose: !0
            }))) : l(t.highlight(a.code, a.grammar, a.language)) : l(t.util.encode(a.code))
        },
        highlight: function(e, s, o) {
            ...
            return t.hooks.run("before-tokenize", i),
                ...
                for (_ in a)
                    if (a.hasOwnProperty(_) && a[_])
                        ...
                        y = 0; y < v.length; ++y) {
                            if (d && d.cause == _ + "," + y)
                                return;
                            var g, v, b, j, y, _, w, O, M, D, m = v[y], S = m.inside, A = !!m.lookbehind, F = !!m.greedy, L = m.alias;
                            F && !m.pattern.global && (M = m.pattern.toString().match(/[imsuy]*$/)[0],
                            m.pattern = RegExp(m.pattern.source, M + "g"));
                            for (var z = m.pattern || m, h = r.next, f = l; h !== o.tail && !(d && f >= d.reach); f += h.value.length,
                            h = h.next) {
                                if (b = h.value,
                                o.length > s.length)
                                    return;
                                if (!(b instanceof n)) {
                                    ...
                                    F) {
                                        ...
                                        var C = g.index
                                          ...
                                          , p = f;
                                        for (p += h.value.length; p <= C; )
                                            h = h.next,
                                            p += h.value.length;
                                        if (p -= h.value.length,
                                        f = p,
                                        h.value instanceof n)
                                            continue;
                                        for (j = h; j !== o.tail && (p < N || "string" == typeof j.value); j = j.next)
                                            O++,
                                            p += j.value.length;
                                        O--,
                                        b = s.slice(f, p),
                                    ...
                                    f += k.length),
                                    u(o, w, O),
                                    D = new n(_,S ? t.tokenize(x, S) : x,L,x),
                                    h = i(o, w, D),
                                    T && i(o, h, T),
                                    1 < O && e(s, o, a, h.prev, f, {
                                        cause: _ + "," + y,
                                        reach: E
                                    })
                                }
    ...
    !t.manual) && (r = document.readyState,
    "loading" === r || "interactive" === r && s && s.defer ? document.addEventListener("DOMContentLoaded", a) : window.requestAnimationFrame ? window.requestAnimationFrame(a) : window.setTimeout(a, 16)),
    t
}(_self);
...
!function(e) {
    ...
    var S = "bool byte char decimal double dynamic float int long object sbyte short string uint ulong ushort var void"
      , l = "class enum interface struct"
      , _ = "add alias and ascending async await by descending from get global group into join let nameof not notnull on or orderby partial remove select set unmanaged value when where"
    ...
    var g = d(l)
      ...
      , m = "\\[\\s*(?:,\\s*)*\\]"
      , z = n("<<0>>(?:\\s*(?:\\?\\s*)?<<1>>)*(?:\\s*\\?)?", [i, m])
      , a = n("(?:<<0>>|<<1>>)(?:\\s*(?:\\?\\s*)?<<2>>)*(?:\\s*\\?)?", [n("\\(<<0>>+(?:,<<0>>+)+\\)", [n("[^,()<>[\\];=+\\-*/%&|^]|<<0>>|<<1>>|<<2>>", [c, C, m])]), i, m])
      , s = {
        keyword: u,
        punctuation: /[<>()?,.:[\]]/
    }
...
'\\\\]|\\\\.|\\\\[Uux][\\da-fA-F]{1,8})'`
    ...
    e.languages.csharp = e.languages.extend("clike", {
        ...
        "class-name": [{
            ...
            pattern: t("(\\busing\\s+<<0>>\\s*=\\s*)<<1>>(?=\\s*;)", [o, a]),
            lookbehind: !0,
            inside: s
        }, {
            ...
            pattern: t("(\\bwhere\\s+)<<0>>", [o]),
            lookbehind: !0
        }, {
            pattern: t("(\\b(?:is(?:\\s+not)?|as)\\s+)<<0>>", [z]),
            lookbehind: !0,
            inside: s
        }, {
            pattern: t("\\b<<0>>(?=\\s+(?!<<1>>)<<2>>(?:\\s*[=,;:{)\\]]|\\s+(?:in|when)\\b))", [a, D, o]),
            inside: s
        }],
        keyword: u,
    ...
    e.languages.insertBefore("csharp", "class-name", {
        namespace: {
            pattern: t("(\\b(?:namespace|using)\\s+)<<0>>(?:\\s*\\.\\s*<<0>>)*(?=\\s*[;{])", [o]),
            lookbehind: !0,
            inside: {
                punctuation: /\./
            }
        ...
        "type-expression": {
            pattern: t("(\\b(?:default|typeof|sizeof)\\s*\\(\\s*(?!\\s))(?:[^()\\s]|\\s(?!\\s)|<<0>>)*(?=\\s*\\))", [C]),
            lookbehind: !0,
            alias: "class-name",
            inside: s
        },
        "return-type": {
            pattern: t("<<0>>(?=\\s+(?:<<1>>\\s*(?:=>|[({]|\\.\\s*this\\s*\\[)|this\\s*\\[))", [a, i]),
            inside: s,
            alias: "class-name"
        },
        ...
        "type-list": {
            pattern: t("\\b((?:<<0>>\\s+<<1>>|where\\s+<<2>>)\\s*:\\s*)(?:<<3>>|<<4>>)(?:\\s*,\\s*(?:<<3>>|<<4>>))*(?=\\s*(?:where|[{;]|=>|$))", [g, p, o, a, u.source]),
            lookbehind: !0,
            inside: {
                keyword: u,
                "class-name": {
    ...
    e.languages.insertBefore("csharp", "class-name", {
        attribute: {
            pattern: t("((?:^|[^\\s\\w>)?])\\s*\\[\\s*)(?:<<0>>\\s*:\\s*)?<<1>>(?:\\s*,\\s*<<1>>)*(?=\\s*\\])", [k, F]),
            lookbehind: !0,
            greedy: !0,
            inside: {
                target: {
                ...
                if (n.language === s) {
                    ...
                    n.code = n.code.replace(o, function(e) {
                        if ("function" == typeof i && !i(e))
                            return e;
                        for (var r, o = a.length; -1 !== n.code.indexOf(r = t(s, o)); )
                            ++o;
                        return a[o] = e,
                        r
                    }),
                ...
                if (n.language === s && n.tokenStack) {
                    ...
                    !function a(r) {
                        for (d = 0; d < r.length && !(o >= i.length); d++)
                            if (c = r[d],
                            "string" == typeof c || c.content && "string" == typeof c.content) {
                                {
                                    var c, d, m = i[o], f = n.tokenStack[m], u = "string" == typeof c ? c : c.content, p = t(s, m), h = u.indexOf(p);
                                    if (-1 < h) {
                                        ++o;
                                        var g = u.substring(0, h)
                                          , b = new e.Token(s,e.tokenize(f, n.grammar),"language-" + s,f)
                                          , v = u.substring(h + p.length)
                                          , l = [];
                                        g && l.push.apply(l, a([g])),
                                        l.push(b),
                                        v && l.push.apply(l, a([v])),
                                        "string" == typeof c ? r.splice.apply(r, [d, 1].concat(l)) : c.content = l
                                    }
                                }
                            } else
...
!function(e) {
    ...
    }, "erb", "javascript", "less", "markdown", "ruby", "scss", "textile"], o = {}, n = 0, i = s.length; n < i; n++)
        t = s[n],
        t = "string" == typeof t ? {
            filter: t,
            language: t
...
!function(e) {
    ...
    for (n in o)
        ...
        "(?:" + i + "|\\w+/(?:[\\w.-]+\\+)+" + a + "(?![+\\w.-]))") : n,
        s[n.replace(/\//g, "-")] = {
            pattern: RegExp("(content-type:\\s*" + r + `.*)(?:\\r?\\n|\\r){2}[\\s\\S]*`, "i"),
            lookbehind: !0,
            inside: o[n]
        });
...
!function(e) {
    var t, n, s = /\/\*[\s\S]*?\*\/|\/\/.*|#(?!\[).*/, o = [{
        ...
        alias: "boolean"
    }, /\b[A-Z_][A-Z0-9_]*\b(?!\s*\()/, /\b(?:null)\b/i], i = /\b0b[01]+(?:_[01]+)*\b|\b0o[0-7]+(?:_[0-7]+)*\b|\b0x[\da-f]+(?:_[\da-f]+)*\b|(?:\b\d+(?:_\d+)*\.?(?:\d+(?:_\d+)*)?|\B\.\d+)(?:e[+-]?\d+)?/i, a = /<?=>|\?\?=?|\.{3}|\??->|[!=]=?=?|::|\*\*=?|--|\+\+|&&|\|\||<<|>>|[?~]|[/^|%*&<>.+-]=?/, r = /[{}[\](),:;]/;
    e.languages.php = {
        delimiter: {
            pattern: /\?>$|^<\?(?:php(?=\s)|=)?/i,
            alias: "important"
    ...
    Object.defineProperty(t, "addSupport", {
        value: function(t, n) {
            ...
            t.forEach(function(t) {
                !function(t, n) {
                    var s, o, r, c, a = "doc-comment", i = e.languages[t];
                    if (i)
                        if (s = i[a],
                        s || (r = {
                            "doc-comment": {
                        ...
                        s = (i = e.languages.insertBefore(t, "comment", r))[a]),
                        s instanceof RegExp && (s = i[a] = {
                            pattern: s
                        }),
                        Array.isArray(s))
                            for (o = 0,
                            c = s.length; o < c; o++)
                                s[o]instanceof RegExp && (s[o] = {
                                    pattern: s[o]
                                }),
                                n(s[o]);
                        else
...
!function(e) {
    ...
    for (var t, o, a, i = ["function", "function-variable", "method", "method-variable", "property-access"], s = 0; s < i.length; s++)
        o = i[s],
        t = e.languages.javascript[o],
        "RegExp" === e.util.type(t) && (t = e.languages.javascript[o] = {
            pattern: t
        }),
        a = t.inside || {},
...
!function(e) {
    ...
    var t = "[-+*/_~!@$%^=<>{}\\w]+"
      ...
      , n = {
        ...
        keyword: [{
            pattern: RegExp(s + "(?:(?:lexical-)?let\\*?|(?:cl-)?letf|if|when|while|unless|cons|cl-loop|and|or|not|cond|setq|error|message|null|require|provide|use-package)" + d),
            lookbehind: !0
        }, {
            pattern: RegExp(s + "(?:for|do|collect|return|finally|append|concat|in|by)" + d),
            lookbehind: !0
        }],
        declare: {
            pattern: r("declare"),
        ...
        defvar: {
            pattern: RegExp(s + "def(?:var|const|custom|group)\\s+" + t),
            lookbehind: !0,
            inside: {
                keyword: /^def[a-z]+/,
                variable: RegExp(t)
        ...
        defun: {
            pattern: RegExp(s + "(?:cl-)?(?:defun\\*?|defmacro)\\s+" + t + "\\s+\\([\\s\\S]*?\\)"),
            lookbehind: !0,
            inside: {
                keyword: /^(?:cl-)?def\S+/,
                arguments: null,
        ...
        lambda: {
            pattern: RegExp(s + "lambda\\s+\\(\\s*(?:&?" + t + "(?:\\s+&?" + t + ")*\\s*)?\\)"),
            lookbehind: !0,
            inside: {
                keyword: /^lambda/,
                arguments: null,
    ...
    n.lambda.inside.arguments = a,
    n.defun.inside.arguments = e.util.clone(a),
    n.defun.inside.arguments.inside.sublist = a,
    e.languages.lisp = n,
    e.languages.elisp = n,
    e.languages.emacs = n,
    e.languages["emacs-lisp"] = n
}(Prism),
...
!function(e) {
    n = e.util.clone(e.languages.javascript),
    ...
    var n, t = function(e) {
        ...
        for (var o, r, c, i = [], a = 0; a < n.length; a++)
            o = n[a],
            c = !1,
            ("string" != typeof o && ("tag" === o.type && o.content[0] && "tag" === o.content[0].type ? "</" === o.content[0].content[0].content ? 0 < i.length && i[i.length - 1].tagName === t(o.content[0].content[1]) && i.pop() : "/>" === o.content[o.content.length - 1].content || i.push({
                tagName: t(o.content[0].content[1]),
                openedBraces: 0
            }) : 0 < i.length && "punctuation" === o.type && "{" === o.content ? i[i.length - 1].openedBraces++ : 0 < i.length && 0 < i[i.length - 1].openedBraces && "punctuation" === o.type && "}" === o.content ? i[i.length - 1].openedBraces-- : c = !0),
            (c || "string" == typeof o) && 0 < i.length && 0 === i[i.length - 1].openedBraces) && (r = t(o),
            a < n.length - 1 && ("string" == typeof n[a + 1] || "plain-text" === n[a + 1].type) && (r += t(n[a + 1]),
            n.splice(a + 1, 1)),
            0 < a && ("string" == typeof n[a - 1] || "plain-text" === n[a - 1].type) && (r = t(n[a - 1]) + r,
            n.splice(a - 1, 1),
            a--),
...
!function(e) {
    var t, n = e.util.clone(e.languages.typescript);
...
!function(e) {
    ...
    e.languages.toml = {
        ...
        table: {
            pattern: RegExp(t("(^\\s*\\[\\s*(?:\\[\\s*)?)__(?:\\s*\\.\\s*__)*(?=\\s*\\])"), "m"),
            lookbehind: !0,
            greedy: !0,
            alias: "class-name"
        },
...
!function(e) {
    var n = /[*&][^\s[\]{},]+/
      , s = /!(?:<[\w\-%#;/?:@&=+$,.!~*'()[\]]+>|(?:[a-zA-Z\d-]*!)?[\w\-%#;/?:@&=+$.~*'()]+)?/
      , o = "(?:" + s.source + "(?:[ 	]+" + n.source + ")?|" + n.source + "(?:[ 	]+" + s.source + ")?)"
...
?])[ 	]*(?:<<prop>>[ 	]+)?)<<key>>(?=\\s*:\\s)`.replace(/<<prop>>/g, function() {
        ...
        datetime: {
            pattern: t("\\d{4}-\\d\\d?-\\d\\d?(?:[tT]|[ 	]+)\\d\\d?:\\d{2}:\\d{2}(?:\\.\\d*)?(?:[ 	]*(?:Z|[-+]\\d\\d?(?::\\d{2})?))?|\\d{4}-\\d{2}-\\d{2}|\\d\\d?:\\d{2}(?::\\d{2}(?:\\.\\d*)?)?"),
            lookbehind: !0,
            alias: "number"
        },
        boolean: {
        ...
        number: {
            pattern: t("[+-]?(?:0x[\\da-f]+|0o[0-7]+|(?:\\d+(?:\\.\\d*)?|\\.?\\d+)(?:e[+-]?\\d+)?|\\.inf|\\.nan)", "i"),
            lookbehind: !0
        },
        tag: s,
        important: n,
...
!function() {
    if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
        ...
        Prism.hooks.add("before-sanity-check", function(t) {
            var s, n = t.element.parentElement, o = n && n.getAttribute("data-line");
            n && o && /pre/i.test(n.nodeName) && (s = 0,
            e(".line-highlight", n).forEach(function(e) {
                s += e.textContent.length,
                e.parentNode.removeChild(e)
            }),
            s && /^( \n)+$/.test(t.code.slice(-s)) && (t.code = t.code.slice(0, -s)))
        }),
        Prism.hooks.add("complete", function e(n) {
            var c, l, s = n.element.parentElement, a = s && s.getAttribute("data-line");
            s && a && /pre/i.test(s.nodeName) && (clearTimeout(i),
            c = Prism.plugins.lineNumbers,
            l = n.plugins && n.plugins.lineNumbers,
            t(s, "line-numbers") && c && !l ? Prism.hooks.add("line-numbers", e) : (o(s, a)(),
            i = setTimeout(r, 1)))
        }),
    ...
    function o(n, o, i) {
        var h, v, b = (o = "string" == typeof o ? o : n.getAttribute("data-line")).replace(/\s+/g, "").split(",").filter(Boolean), y = +n.getAttribute("data-line-offset") || 0, j = (c() ? parseInt : parseFloat)(getComputedStyle(n).lineHeight), u = t(n, "line-numbers"), l = n.querySelector("code"), f = u ? n : l || n, r = [], p = l && f != l ? function(e, t) {
            var o = getComputedStyle(e)
              , s = getComputedStyle(t);
            function n(e) {
                return +e.substr(0, e.length - 2)
            }
            return t.offsetTop + n(s.borderTopWidth) + n(s.paddingTop) - n(o.paddingTop)
        }(n, l) : 0;
        if (b.forEach(function(e) {
            var a, c, d, h, l = e.split("-"), s = +l[0], o = +l[1] || s, t = n.querySelector('.line-highlight[data-range="' + e + '"]') || document.createElement("div");
            r.push(function() {
                t.setAttribute("aria-hidden", "true"),
                t.setAttribute("data-range", e),
                t.className = (i || "") + " line-highlight"
            }),
            u && Prism.plugins.lineNumbers ? (a = Prism.plugins.lineNumbers.getLine(n, s),
            c = Prism.plugins.lineNumbers.getLine(n, o),
            a && (d = a.offsetTop + p + "px",
            r.push(function() {
                t.style.top = d
            })),
            c && (h = c.offsetTop - a.offsetTop + c.offsetHeight + "px",
            r.push(function() {
                t.style.height = h
            }))) : r.push(function() {
                t.setAttribute("data-start", String(s)),
                s < o && t.setAttribute("data-end", String(o)),
                t.style.top = (s - y - 1) * j + p + "px",
...
`)
        ...
        h = n.id,
        u && h) {
            for (var m = "linkable-line-numbers", g = !1, d = n; d; ) {
                if (t(d, m)) {
                    g = !0;
                    break
                }
            ...
            g && (t(n, m) || r.push(function() {
                n.className = (n.className + " " + m).trim()
            }),
            v = parseInt(n.getAttribute("data-start") || "1"),
    ...
    function r() {
        ...
        i && !document.getElementById(t)) {
            ...
            o(n, i, "temporary ")(),
            s && document.querySelector(".temporary.line-highlight").scrollIntoView())
        }
    }
}(),
!function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
        var e = "line-numbers"
          ...
          , o = Prism.plugins.lineNumbers = {
            getLine: function(t, n) {
                if ("PRE" === t.tagName && t.classList.contains(e) && (s = t.querySelector(".line-numbers-rows"),
                s)) {
                    var s, a, o = parseInt(t.getAttribute("data-start"), 10) || 1, i = o + (s.children.length - 1);
                    return n < o && (n = o),
                    i < n && (n = i),
                    a = n - o,
                    s.children[a]
        ...
        Prism.hooks.add("complete", function(s) {
            if (s.code && (i = s.element,
            o = i.parentNode,
            o && /pre/i.test(o.nodeName) && !i.querySelector(".line-numbers-rows") && Prism.util.isActive(i, e))) {
                i.classList.remove(e),
                o.classList.add(e);
                var o, i, a, r = s.code.match(n), c = r ? r.length + 1 : 1, l = new Array(c + 1).join("<span></span>");
                (a = document.createElement("span")).setAttribute("aria-hidden", "true"),
                a.className = "line-numbers-rows",
                a.innerHTML = l,
                o.hasAttribute("data-start") && (o.style.counterReset = "linenumber " + (parseInt(o.getAttribute("data-start"), 10) - 1)),
                s.element.appendChild(a),
                t([o]),
                Prism.hooks.run("line-numbers", s)
            }
        }),
    ...
    function t(e) {
        if (0 != (e = e.filter(function(e) {
            ...
            var t = e.map(function(e) {
                var t, o, i, s = e.querySelector("code"), a = e.querySelector(".line-numbers-rows");
                if (s && a)
                    return t = e.querySelector(".line-numbers-sizer"),
                    o = s.textContent.split(n),
                    t || ((t = document.createElement("span")).className = "line-numbers-sizer",
                    s.appendChild(t)),
                    t.innerHTML = "0",
            ...
            t.forEach(function(e) {
                for (var s = e.sizer, n = e.lineHeights, o = 0, t = 0; t < n.length; t++)
                    void 0 === n[t] && (n[t] = s.children[o++].getBoundingClientRect().height)
            }),
            t.forEach(function(e) {
                var t = e.sizer
...
!function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
        var n, s, t = [], e = {}, o = function() {};
        Prism.plugins.toolbar = {},
        n = Prism.plugins.toolbar.registerButton = function(n, s) {
            var o = "function" == typeof s ? s : function(e) {
                var t;
                return "function" == typeof s.onClick ? ((t = document.createElement("button")).type = "button",
                t.addEventListener("click", function() {
                    s.onClick.call(this, e)
                })) : "string" == typeof s.url ? (t = document.createElement("a")).href = s.url : t = document.createElement("span"),
                s.className && t.classList.add(s.className),
                t.textContent = s.text,
                t
            }
            ;
            n in e ? console.warn('There is a button with the key "' + n + '" registered already.') : t.push(e[n] = o)
        }
        ,
        s = Prism.plugins.toolbar.hook = function(n) {
            if (s = n.element.parentNode,
        ...
        ,
        n("label", function(e) {
            var n, s, o, t = e.element.parentNode;
            if (t && /pre/i.test(t.nodeName) && t.hasAttribute("data-label")) {
                o = t.getAttribute("data-label");
                try {
                    s = document.querySelector("template#" + o)
                } catch {}
                return s ? n = s.content : (t.hasAttribute("data-url") ? (n = document.createElement("a")).href = t.getAttribute("data-url") : n = document.createElement("span"),
                n.textContent = o),
                n
            }
        }),
    ...
    if ("undefined" != typeof self && self.Prism && self.document)
        if (Prism.plugins.toolbar) {
            ...
            Prism.plugins.toolbar.registerButton("show-language", function(t) {
                var n, o, i, s = t.element.parentNode;
                if (s && /pre/i.test(s.nodeName) && (o = s.getAttribute("data-language") || e[t.language] || (n = t.language) && (n.substring(0, 1).toUpperCase() + n.substring(1)).replace(/s(?=cript)/, "S"),
                o))
